...
class Model_2D_2cell_with_ExpotenSteppable(SteppableBasePy):
    ...
    def step(self, mcs):
        ...
        for cell in self.cell_list_by_type(self.SEN):
            print("perimeter", cell.surface, cell.volume)
...
class PlottingSteppable(SteppableBasePy):
    ...
    def start(self):
        ...
        self.plot_coculture_area.add_plot("Cancer cell area", style='Lines', color='red', size=3)
        self.plot_coculture_area.add_plot("SEN area", style='Lines', color='blue', size=3)
        self.plot_coculture_area.add_plot("NON_SEN area", style='Lines', color='green', size=3)        
        ...
        self.plot_no_cells.add_plot("Num_sen", style='Lines', color='cyan', size=4)
        self.plot_no_cells.add_plot("Num_nonsen", style='Lines', color='green', size=4)
        self.plot_no_cells.add_plot("Num_cancer", style='Lines', color='red', size=4)
